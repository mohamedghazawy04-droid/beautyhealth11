...
export const CategoriesModal: React.FC<CategoriesModalProps> = ({
  ...
  const categories = [
    {
      ...
      title: 'جميع المنتجات',
      subtitle: 'تصفح كل منتجات المتجر المتاحة للتوصيل الفوري',
      icon: Layers,
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto bg-black/60 backdrop-blur-xs flex items-end sm:items-center justify-center p-0 sm:p-4">
      ...
      >
        {/* Header */}
        <div className="p-4 sm:p-5 bg-white border-b border-stone-200 flex items-center justify-between sticky top-0 z-10">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-xs text-stone-500 font-medium">
                اختر القسم للتصفح الفوري لمنتجات العناية والطفل
              </p>
            </div>
          </div>
          <button
            ...
            return (
              ...
              >
                ...
                <button
                  ...
                  className="w-full p-4 flex items-center justify-between gap-3 text-right hover:bg-stone-50/80 transition-colors cursor-pointer"
                >
                ...
                {cat.subcategories.length > 0 && (
                  <div className="px-4 pb-3.5 pt-1 border-t border-stone-100 bg-stone-50/60 flex flex-wrap gap-1.5">
